...
function ValidateContactForm() {
	alert("Sorry, This contact form does not allow you to send me messages. Please use the email address provided below to get out to me.\nThank you for visiting my website.")
	return true;
};

function ValidateCv() {
	alert("I'm sorry, but you cannot download my CV. Please hold off till the next time.")
	return true;
};
